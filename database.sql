...
insert into THONGTINCUAHANG values ('CH001', '140 Lê Trọng Tấn, Phường Tây Thạnh, Quận Tân Phú, TPHCM', '0334661938', 'huynhthebao.201020020@gmail.com', N'Huỳnh Thế Bảo')
--bảng nhân viên
...
(
	...
	SDT		CHAR(11),
	DIACHI	NVARCHAR(MAX),
	LOAIKH	NVARCHAR(20) DEFAULT N'' CHECK(LOAIKH = N'Khách vãng lai' OR LOAIKH = N'Khách tích điểm')
)
GO
--Bảng hóa đơn
CREATE TABLE HOADON
...
exec Select_CTHoaDon 'HD10'
SELECT * FROM HOADON
insert into HOADON(MAHD, MAKH, MANV) VALUES ('HD005', 'VL000', 'NV001')
insert into CT_HOADON(MAHD, MASP, SOLUONG) VALUES ('HD005', '01010101', '10')
DELETE FROM CT_HOADON WHERE MAHD = 'HD005' AND MASP = '01010101'
UPDATE HOADON SET TRANGTHAI = N'Đã xuất hóa đơn' WHERE MAHD = 'HD005'
SELECT * FROM SANPHAM