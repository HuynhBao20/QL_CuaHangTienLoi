...
UPDATE HOADON SET TRANGTHAI = N'Đã hủy', TIENKD = 0 WHERE MAHD = 'HD005'
exec Select_CTHoaDon 'HD083'

SELECT * FROM HOADON WHERE TRANGTHAI = N'Đã xuất hóa đơn'

SELECT hd.MAHD, COUNT(*) 
